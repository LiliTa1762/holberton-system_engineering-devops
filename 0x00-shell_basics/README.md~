In this part: we have to make the first script, in a new repository and  new directory.
...
In the case of the 4-listmorefiles it is for display hidden files, using a long format of the contents of the current directory.